...
public interface ICourseService
{
    ...
    Task<GetCoursesResponse> GetCourses(string keyword, string location, int? distance, List<int> routeIds, List<int> levels, OrderBy orderBy, CancellationToken cancellationToken);
