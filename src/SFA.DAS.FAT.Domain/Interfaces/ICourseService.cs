...
public interface ICourseService
{
    ...
    Task<GetCoursesResponse> GetCourses(string keyword, string location, int? distance, List<int> routeIds, List<int> levels, int? page, OrderBy orderBy, CancellationToken cancellationToken);
