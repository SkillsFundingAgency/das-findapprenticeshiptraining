...
namespace SFA.DAS.FAT.Web.UnitTests.Controllers.CoursesControllerTests
{
    public class WhenGettingCourseDetails
    {
            ...
            [Greedy] CoursesController controller)
        {
            ...
            validator.Setup(v => v.Validate(It.IsAny<GetCourseQuery>())).Returns(new ValidationResult());
            ...
            [Greedy] CoursesController controller)
        {
            ...
            validator.Setup(v => v.Validate(It.IsAny<GetCourseQuery>())).Returns(new FluentValidation.Results.ValidationResult());
        ...
        [Test, MoqAutoData]
        public async Task Then_CourseId_Is_Invalid_And_ValidationExceptionThrown(
            [Frozen] Mock<IValidator<GetCourseQuery>> validator,
            [Greedy] CoursesController controller)
        {
