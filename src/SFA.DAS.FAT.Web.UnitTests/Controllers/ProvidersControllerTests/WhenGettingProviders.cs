...
public class WhenGettingProviders
{
    ...
    public async Task Then_The_Courses_Are_Set_Up(int? coursesCount, int expectedCount, string dropdownText, bool showCoursesExpected)
    {
        var ukprn = 12345678;
        ...
        var controller = new ProvidersController(mediator.Object);

        var actual = await controller.Index(ukprn, null);
        ...
        var sut = actualVm!.Model as ProviderDetailsViewModel;
    ...
    public async Task Then_The_Qar_Is_Set_Up(string leavers, string achievementRate,
    ...
    public async Task Then_EndpointAssessments_Are_Set_Up(int? endpointAssessmentCount, int earliestYear, string expectedFormattedCount, string expectedEndpointAssessmentDetails)
    {
        var ukprn = 12345678;
    ...
    public async Task Then_ReviewDetails_Are_Set_Up(
    ...
    public async Task Then_ReviewRatings_Are_Set_Up(
    ...
    public async Task Then_ComposedAddress_Is_Set(
    ...
    public async Task Then_ComposedWebsite_Is_Set(bool isContactSetUp, string website, string expectedWebsite)
    {
        var ukprn = 12345678;
