namespace SFA.DAS.FAT.Web.UnitTests.Controllers.ShortlistControllerTests
{
    ...
    //                    It.Is<GetShortlistsForUserQuery>(c => c.ShortlistUserId.Equals(shortlistCookie.ShortlistUserId)),
    ...
    //            var model = actual.Model as ShortlistsViewModel;
    ...
    //                    It.IsAny<GetShortlistsForUserQuery>(),
    //                    It.IsAny<CancellationToken>()),
    //                Times.Never);
    //        }
