namespace SFA.DAS.FAT.Web.UnitTests.Models.CourseProvidersViewModelTests
{
    ...
    //         
    //         var actual = model.ClearLocationLink;
    //         actual.Should().StartWith($"?location=-1&deliveryModes={string.Join("&deliveryModes=", model.DeliveryModes.Select(c => c.DeliveryModeChoice))}");
    //     }
    //     
    //     [Test, AutoData]
