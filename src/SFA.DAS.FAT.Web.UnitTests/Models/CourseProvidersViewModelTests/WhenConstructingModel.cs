namespace SFA.DAS.FAT.Web.UnitTests.Models.CourseProvidersViewModelTests
{
    public class WhenConstructingModel
    {
        ...
        //            {
        //                DeliveryModeChoice = deliveryModeType,
        ...
        //        model.DeliveryModes.Should().BeEquivalentTo(expectedDeliveryModes.Where(c => c.DeliveryModeChoice != DeliveryModeType.NotFound));
        //    }
        ...
        //        model.DeliveryModes.Where(c => c.Selected).Select(c => c.DeliveryModeChoice).ToList().Should()
